...
<head>
    ...
    <title>Pepper Place Resident Portal</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
           ...
           <li class="dropdown">
                    ...
                    <ul class="dropdown-menu alert-dropdown" id="alertlist">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="margin-left: 20px; padding-left: 2cm;">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Hi Kakashi Hatake</strong> 
                        </div>
                    </div>
                </div>
                <!-- /.row -->
    ...
    $(document).ready(function(){
    	...
    	$.ajax({
    		type : 'GET',
    		url : "/ApartmentPortal/rest/services/adminalerts", 
